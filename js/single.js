...
function openSinglePage(type, id) {
    ...
    document.getElementById('singlePage').classList.remove('hidden');
    ...
    loadSingleContent(type, id);
}

function goBackToList() {
    document.getElementById('singlePage').classList.add('hidden');
    
    if (currentSingleType === 'teacher') {
...
function renderTeacherDetail(teacher) {
    ...
    detailContent.innerHTML = `
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div class="flex flex-col gap-6 rounded-xl border lg:col-span-1 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <span class="inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 gap-1 border-transparent bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 mb-4">
                            ${teacher.subject || 'Teacher'}
                        </span>
                        <div class="w-full space-y-4 mb-6">
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600 dark:text-gray-400">Age</span>
                                <span class="text-gray-900 dark:text-white">${teacher.age || 'N/A'} years</span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600 dark:text-gray-400">Experience</span>
                                <span class="text-gray-900 dark:text-white">${teacher.experience || 'N/A'} years</span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                            ...
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-900 dark:text-white">${normalizedRating}</span>
                                </div>
                            </div>
                            <div class="bg-gray-200 dark:bg-gray-700 relative w-full overflow-hidden rounded-full h-2">
            ...
            <div class="flex flex-col gap-6 rounded-xl border lg:col-span-2 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <div class="flex flex-col gap-2 w-full">
                    <div class="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 px-6 pt-6 pb-6">
                        <div role="tablist" aria-orientation="horizontal" class="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 h-9 items-center justify-center rounded-xl p-1 grid w-full grid-cols-2">
                            <button type="button" role="tab" aria-selected="true" class="bg-white dark:bg-gray-800 text-gray-900 dark:text-white h-full flex-1 items-center justify-center rounded-lg border border-transparent px-2 py-1 text-sm font-medium transition-colors">
                                Contact Info
                            </button>
                            <button type="button" role="tab" aria-selected="false" class="h-full flex-1 items-center justify-center rounded-lg border border-transparent px-2 py-1 text-sm font-medium transition-colors hover:bg-white/50 dark:hover:bg-gray-700/50">
                                Assigned Students (3)
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900 dark:text-white">${teacher.phone || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900 dark:text-white truncate">${teacher.email || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900 dark:text-white">${teacher.twitter || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-900 dark:text-white truncate">${teacher.linkedin || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function renderStudentDetail(student) {
    ...
    const ratingPercentage = Math.min((normalizedRating / 5) * 100, 100);
    const coinsPercentage = Math.min(((student.coins || 0) / 500) * 100, 100);
    ...
    detailContent.innerHTML = `
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="p-6">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <div class="w-full space-y-4 mb-6">
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600 dark:text-gray-400">Age</span>
                                <span class="text-gray-900 dark:text-white">${student.age || 'N/A'} years</span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600 dark:text-gray-400">Gender</span>
                            ...
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-900 dark:text-white">${student.coins || 0}</span>
                                </div>
                            </div>
                            <div class="bg-gray-200 dark:bg-gray-700 relative w-full overflow-hidden rounded-full h-2">
            ...
            <div class="flex flex-col gap-6 rounded-xl border lg:col-span-2 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                <div class="flex flex-col gap-2 w-full">
                    <div class="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 px-6 pt-6 pb-6">
                        <div role="tablist" aria-orientation="horizontal" class="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 h-9 items-center justify-center rounded-xl p-1 grid w-full grid-cols-3">
                            <button type="button" role="tab" aria-selected="true" class="bg-white dark:bg-gray-800 text-gray-900 dark:text-white h-full flex-1 items-center justify-center rounded-lg border border-transparent px-2 py-1 text-sm font-medium transition-colors">
                                Contact Info
                            </button>
                            <button type="button" role="tab" aria-selected="false" class="h-full flex-1 items-center justify-center rounded-lg border border-transparent px-2 py-1 text-sm font-medium transition-colors hover:bg-white/50 dark:hover:bg-gray-700/50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-600 dark:text-gray-400">Email</p>
                                            <p class="text-gray-900 dark:text-white truncate">${student.email || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-600 dark:text-gray-400">Twitter</p>
                                            <p class="text-gray-900 dark:text-white">${student.twitter || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-600 dark:text-gray-400">LinkedIn</p>
                                            <p class="text-gray-900 dark:text-white truncate">${student.linkedin || 'N/A'}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
